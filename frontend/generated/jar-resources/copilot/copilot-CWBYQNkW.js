...
}, w = /* @__PURE__ */ On(kn, Ho), Ln = "computed", Fo = "computed.struct", cr = /* @__PURE__ */ Or(Ln), Wo = /* @__PURE__ */ Or(Fo, {
...
const rt = "copilot-", Ka = "24.4.1", pl = "attention-required", gl = "https://plugins.jetbrains.com/plugin/23758-vaadin", _l = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", bl = (e, t, r) => t >= e.left && t <= e.right && r >= e.top && r <= e.bottom, qa = (e) => {
  const t = [];
  let r = Fa(e);
  for (; r; )
...
const Ya = !!document.querySelector("copilot-main");
window.Vaadin ??= {};
...
Ya && (window.Vaadin.copilot._machineState = new Za());
/**
 * @license
...
const ce = (e) => new Si(typeof e == "string" ? e : e + "", void 0, Tr), es = (e, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: rs, defineProperty: ns, getOwnPropertyDescriptor: is, getOwnPropertyNames: os, getOwnPropertySymbols: as, getPrototypeOf: ss } = Object, Xt = globalThis, nn = Xt.trustedTypes, ls = nn ? nn.emptyScript : "", cs = Xt.reactiveElementPolyfillSupport, Ge = (e, t) => e, gr = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? ls : null;
      break;
  ...
  return r;
} }, Ni = (e, t) => !rs(e, t), on = { attribute: !0, type: String, converter: gr, reflect: !1, hasChanged: Ni };
...
let Pe = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, r, n) {
    const { get: i, set: o } = is(this.prototype, t) ?? { get() {
      return this[r];
    }, set(a) {
      this[r] = a;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Ge("properties"))) {
      const r = this.properties, n = [...os(r), ...as(r)];
      for (const i of n)
...
Pe.elementStyles = [], Pe.shadowRootOptions = { mode: "open" }, Pe[Ge("elementProperties")] = /* @__PURE__ */ new Map(), Pe[Ge("finalized")] = /* @__PURE__ */ new Map(), cs?.({ ReactiveElement: Pe }), (Xt.reactiveElementVersions ??= []).push("2.0.4");
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Vr = globalThis, Lt = Vr.trustedTypes, sn = Lt ? Lt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Rr = "$lit$", Z = `lit$${(Math.random() + "").slice(9)}$`, jr = "?" + Z, hs = `<${jr}>`, Ee = document, it = () => Ee.createComment(""), ot = (e) => e === null || typeof e != "object" && typeof e != "function", xi = Array.isArray, $i = (e) => xi(e) || typeof e?.[Symbol.iterator] == "function", rr = `[ 	
\f\r]`, Ke = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ln = /-->/g, cn = />/g, se = RegExp(`>|${rr}(?:([^\\s"'>=/]+)(${rr}*=${rr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), un = /'/g, dn = /"/g, Di = /^(?:script|style|textarea|title)$/i, Pi = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), _r = Pi(1), $l = Pi(2), Oe = Symbol.for("lit-noChange"), A = Symbol.for("lit-nothing"), hn = /* @__PURE__ */ new WeakMap(), he = Ee.createTreeWalker(Ee, 129);
function Ci(e, t) {
...
const Ti = (e, t) => {
  ...
  for (let l = 0; l < r; l++) {
    ...
    o += a === Ke ? s + hs : u >= 0 ? (n.push(c), s.slice(0, u) + Rr + s.slice(u) + Z + p) : s + Z + (u === -2 ? l : p);
  }
...
const vs = { P: Rr, A: Z, C: jr, M: 1, L: Ti, R: Vi, D: $i, V: Ae, I: Ue, H: pt, N: ji, U: ki, B: Ri, F: Li }, fs = Vr.litHtmlPolyfillSupport;
fs?.(at, Ue), (Vr.litHtmlVersions ??= []).push("3.1.2");
const ps = (e, t, r) => {
...
function ys() {
  ue.push(import("./copilot-log-plugin-ZFjdHnYT.js")), ue.push(import("./copilot-info-plugin-BGps-nfK.js")), ue.push(import("./copilot-features-plugin-CUiqsjiq.js")), ue.push(import("./copilot-feedback-plugin-CC8TFBSi.js")), ue.push(import("./copilot-shortcuts-plugin-B4Fhr71t.js"));
}
function Es() {
  {
...
const qe = window.Vaadin.copilot.overlayManager, Pl = {
...
}, ws = async (e, t, r) => window.Vaadin.copilot.comm(e, t, r);
var Mi = /* @__PURE__ */ ((e) => (e.INFORMATION = "information", e.WARNING = "warning", e.ERROR = "error", e))(Mi || {});
function Ss() {
  return import("./copilot-notification-DKtUODH9.js");
}
function Ui(e, t) {
...
const Bi = () => {
  Ns().then((e) => _.setUserInfo(e)).catch((e) => Ui("Failed to load userInfo", e));
}, Ns = async () => ws(`${rt}get-user-info`, {}, (e) => (delete e.data.reqId, e.data)), xs = async () => wi(() => _.userInfo), Cl = async () => (await xs()).vaadiner;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ki = Symbol.for(""), js = (e) => {
  if (e?.r === Ki)
    return e?._$litStatic$;
}, qi = (e) => ({ _$litStatic$: e, r: Ki }), gn = /* @__PURE__ */ new Map(), ks = (e) => (t, ...r) => {
  const n = r.length;
  let i, o;
  const a = [], l = [];
  let s, c = 0, d = !1;
  for (; c < n; ) {
    for (s = t[c]; c < n && (o = r[c], (i = js(o)) !== void 0); )
      s += i + t[++c], d = !0;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ls = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, Is = (e) => (...t) => ({ _$litDirective$: e, values: t });
let Ms = class {
  constructor(t) {
  }
  get _$AU() {
...
const { I: Us } = vs, _n = () => document.createComment(""), He = (e, t, r) => {
  ...
  return r;
}, le = (e, t, r = e) => (e._$AI(t, r), e), Bs = {}, zs = (e, t = Bs) => e._$AH = t, Ks = (e) => e._$AH, ir = (e) => {
  e._$AP?.(!1, !0);
  let t = e._$AA;
...
const bn = (e, t, r) => {
  ...
  for (let i = t; i <= r; i++)
    n.set(e[i], i);
  return n;
}, Hi = Is(class extends Ms {
  constructor(e) {
    if (super(e), e.type !== Ls.CHILD)
  ...
  update(e, [t, r, n]) {
    const i = Ks(e), { values: o, keys: a } = this.dt(t, r, n);
    if (!Array.isArray(i))
      return this.ut = a, o;
    const l = this.ut ??= [], s = [];
    ...
    return this.ut = a, zs(e, s), Oe;
  }
}), Nt = /* @__PURE__ */ new Map(), qs = (e) => {
...
kr.exports = Gi;
var al = kr.exports;
const sl = /* @__PURE__ */ ol(al);
var ll = Object.defineProperty, cl = Object.getOwnPropertyDescriptor, ul = (e, t, r, n) => {
  for (var i = n > 1 ? void 0 : n ? cl(t, r) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (i = (n ? a(t, r, i) : a(i)) || i);
  return n && i && ll(t, r, i), i;
};
let yn = class extends bs {
  constructor() {
    super(...arguments), this.removers = [], this.initialized = !1, this.operationInProgressCursorUpdate = sl(() => {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, document.body.style.setProperty("--dev-tools-button-display", "none"), await import("./copilot-global-vars-later-SPe_YAeX.js"), await import("./copilot-init-step2-8Hr-WzsF.js"), ys(), this.tabIndex = 0, yt.hostConnectedCallback(), window.addEventListener("keydown", pn), $.onSend(this.handleSendEvent), this.removers.push($.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
  ...
  updated(e) {
    super.updated(e), this.attachActivationButtonToBody(), Ys();
  }
...
dl.devToolsPlugins.push(hl);
const vl = window.litIssuedWarnings ??= /* @__PURE__ */ new Set();
vl.add(
